...
plot(hflightsSub$ArrDelay, 
     ...
     main = "Arrival Delay vs. Departure Delay", 
     xlab = "Arrival Delay", 
     ylab = "Departure Delay")

 
p <- qplot(hflightsSub$ArrDelay, 
           hflightsSub$DepDelay,
           main = "Arrival Delay vs. Departure Delay", 
           xlab = "Arrival Delay", 
           ylab = "Departure Delay") 
...
#5 
boxplot(hflightsSub$DepDelay ~hflights)


bp <- ggplot(hflightsSub, aes(x = DayOfWeek, y = DepDelay, group = DayOfWeek))
+ geom_boxplot()
```
